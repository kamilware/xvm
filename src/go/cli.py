...
from src.go.install import install
from src.go.list import list_installed_versions, list_available_versions, is_installed
from src.go.rc import activate
from src.go.uninstall import uninstall
from src.go.update import setup_autoupdate_service, SYSTEMD_SERVICE_PATH, remove_autoupdate_service, \
    SYSTEMD_SERVICE_NAME
from src.go.utils import normalise_version, get_latest_stable_version
from src.go.install import send_notification
...
from src.shared.term import info, TermColor, warn, error
